...
pub fn translate(key: I18nKey) -> &'static str {
    match key {
        ...
        I18nKey::HelpDescBookmarksModal => "Serveurs SSH & Quick-Connect",
        I18nKey::HelpDescExportSession => "Exporter la session en rapport Markdown",
        I18nKey::HelpDescMcpModal => "Serveurs & Outils MCP (Model Context Protocol)",
        I18nKey::HelpDescChatSearch => "Rechercher dans l'historique du chat",
        I18nKey::HelpDescDiagnoseError => "Diagnostiquer & réparer l'erreur de commande",
